 ...
 */
public class AnalyzeSpringClassDependencyStarter {
    public static void main(String[] args) throws IOException {
        System.out.println("Hello world!");

        ConfigurableApplicationContext context = new AnnotationConfigApplicationContext(AnalyzeSpringClassDependencyStarter.class);
