...
public class Main {
    public static void main(String[] args) {
        ...
        // 域命名规范前缀
        String moduleRule = "com.kuaishou.ad.brand.platform";
        // 待扫描输出excel内容的 扫描类文件路径
        List<String> scanPathList = Arrays.asList(
                "/Users/lianguowei/Documents/soft/ideaProject/ad-brand-platform/ad-brand-platform-api/src/main/java/com/ad/brand/platform/controller/creative/CreativeController.java"
                , "/Users/lianguowei/Documents/soft/ideaProject/ad-brand-platform/ad-brand-platform-api/src/main/java/com/ad/brand/platform/controller/AppController.java"
        );
